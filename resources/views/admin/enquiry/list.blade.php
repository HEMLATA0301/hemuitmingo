...
@section('content')
    <div class="table-data__tool">
        <div class="table-data__tool-left h5" >
            <h3 class="title-5 ">Enquiry List</h3>
        </div>
            ...
            <tbody>
                @forelse ($enquiries as $row)
                    <tr>
                        ...
                        <td>{{ $row->subject }}</td>
                        <td>
                            <button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#scrollmodal" onclick="message({{ $row->id }});">
                                Show
                            </button>
                ...
                @empty
                    <tr>
                        <td colspan="9" class="text-center">Empty Enquiry Record</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
