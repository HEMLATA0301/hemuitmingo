                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            <img src="{{ asset('assets/image/logo.png') }}" alt="Vidwetha Logo" />
                        </a>
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="far fa-check-square"></i>Session</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="{{ route('session_master.create') }}">Add Session</a>
                                </li>
                                <li>
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="">
                                <i class="far fa-check-square"></i>None</a>
                        </li>
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="{{ route('enquiry.index') }}">
                                <i class="far fa-check-square"></i>Enquiry</a>
                        </li>

                        <li class="has-sub">
                            <a class="js-arrow" href="{{ route('career.index') }}">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="far fa-check-square"></i>Our Customer</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="{{ route('dashboard') }}">
                    <img src="{{ asset('web/images/logo.png')}}" alt="Logo" width="100px;">
                </a>
            </div>
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="{{ route('enquiry.index') }}">
                                <i class="far fa-check-square"></i>Enquiry
                            </a>
                        </li>
                        ...
                        <div class="header-wrap">
                            ...
                            <div class="header-button">
                                <div class="noti-wrap ">
                                    ...
                                    <div class="noti__item js-item-menu none">
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item none">
                                                    <a href="#">
            ...
            <div class="main-content">
                ...
                <footer class="fixed-bottom">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="copyright">
                                <p>Copyright © {{ date('Y') }} . All rights reserved by <a href="https://itmingo.com/" target="_blank" class="text-dark">IT Mingo LLP</a></p>
                            </div>
                        </div>
                    </div>
                </footer>
